...
import com.example.demo.common.GrdaData;
...
public class RestBoardController {
	...
	public Map modifyData(@RequestBody GrdaData<BoardDTO> board) {
	...
	public Map register(@RequestBody GrdaData<BoardDTO> board) {
	...
	//수정 처리
	@PutMapping("/update")
	public Map modify(@RequestBody GrdaData<BoardDTO> board) {
		log.info("modify: " + board);
		//service.modify(board);
		return Collections.singletonMap("result", true);
	}
