...
public class ChatFewShotCompletion {
    public static void main(String[] args) {
        ...
        ChatCompletionCreateParams createParams = ChatCompletionCreateParams.builder()
                ...
                .addUserMessage("질문 예시 1: 2 + 2 = ?")
                .addAssistantMessage("답: 4")
            //    .addUserMessage("질문 예시 2: 3 * 3 = ?")
           //     .addAssistantMessage("답: 9")
                .addUserMessage("질문: 5 + 7 = ?")
